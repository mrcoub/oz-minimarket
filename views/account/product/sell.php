...
<div class="menu-account">
  ...
  <a href="/account/product/sell/" class="waves-effect waves-light btn disabled">Проданные Товары</a>
  <a href="/account/edit/" class="waves-effect waves-light btn">Изменить профиль</a>
</div>

<div class="section">
	<?php if (count($arOrdersSell) < 1): ?>
		<h5>Проданные товары отсутствуют</h5>
	<?php else: ?>
		<h5>Список проданных товаров</h5>
		<table class="striped">
			<thead>
				<tr>
					<th>ID</th>
			...
			<tbody>
				<?php foreach ($arOrdersSell as $order): ?>
				<tr>
...
<div id="modal" class="modal bottom-sheet open" style="z-index: 1007; display: none; opacity: 1; bottom: 0px;">
	<div class="modal-content">
		<h4>Контакты продавца товара</h4>
		<ul class="collection">
...
<script>
	$(function() {
		$("a.contact").click(function () {
			...
			$.post("/order/getContactSell/"+id, {}, function (data) {
				$('#modal').modal();
